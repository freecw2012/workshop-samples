...
public class EventWriter {
    ...
    public static void main(String[] args) {
        final String scope = IngestParameters.getScope();
        final String streamName = IngestParameters.getStreamName();
        final String routingKey = IngestParameters.getRoutingKeyAttributeName();
        final String message = "hello world";
        final URI controllerURI = IngestParameters.getControllerURI();
