...
public class StreamCreator {
    ...
    public static void main(String[] args) {
        final URI controllerURI = OperationParameters.getControllerURI();
        final String scope = OperationParameters.getScope();
        final String stream = OperationParameters.getStreamName();
